...
namespace milestone2
{
    ...
    public partial class EntityContext : DbContext
    {
        ...
        [DbFunction("EntityContext", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[EntityContext].[ufnGetAllCategories]()");
        }
    
        [DbFunction("EntityContext", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[EntityContext].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
